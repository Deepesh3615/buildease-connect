...
const translations: Record<string, Record<Language, string>> = {
  ...
  "auth.username": { en: "Username", hi: "उपयोगकर्ता नाम", mr: "वापरकर्तानाव" },
  "auth.usernamePlaceholder": { en: "Enter Username", hi: "उपयोगकर्ता नाम दर्ज करें", mr: "वापरकर्तानाव प्रविष्ट करा" },
  "auth.usernameHelper": { en: "This will be used to login", hi: "इससे लॉगिन किया जाएगा", mr: "यावरून लॉगिन केले जाईल" },
  "auth.usernameRules": { en: "4–15 characters, letters & numbers only", hi: "4–15 अक्षर, केवल अक्षर और संख्या", mr: "4–15 अक्षरे, फक्त अक्षरे आणि संख्या" },
  "auth.usernameExists": { en: "Username already taken", hi: "उपयोगकर्ता नाम पहले से लिया गया है", mr: "वापरकर्तानाव आधीच घेतले आहे" },
  "auth.usernameInvalid": { en: "Invalid username format", hi: "अमान्य उपयोगकर्ता नाम", mr: "अवैध वापरकर्तानाव" },
  "auth.rememberUsername": { en: "Remember Username", hi: "उपयोगकर्ता नाम याद रखें", mr: "वापरकर्तानाव लक्षात ठेवा" },
  "auth.enterUsername": { en: "Enter your username", hi: "अपना उपयोगकर्ता नाम दर्ज करें", mr: "तुमचे वापरकर्तानाव प्रविष्ट करा" },
